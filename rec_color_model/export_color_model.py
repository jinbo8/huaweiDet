...
if __name__=="__main__":
    ...
    parser.add_argument('--weights', type=str, default='plate_rec_color0325.pth', help='weights path')  # from yolov5/models/
    parser.add_argument('--save_path', type=str, default='plate_rec_color0325.onnx', help='onnx save path')
    ...
    torch.onnx.export(model,input,onnx_file_name,
                      input_names=["input"], output_names=["output1", "output2"],
                      verbose=False,
                      opset_version=11,

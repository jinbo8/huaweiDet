...
if __name__ == '__main__':
    ...
    parser.add_argument('--detect_model', nargs='+', type=str, default='/home/dell/桌面/huaweiDetOCR/weights/plate_det_deploy/yolov7-lite-s.pt', help='model.pt path(s)')  # 1.目标检测模型
    parser.add_argument('--rec_model', type=str, default='/home/dell/桌面/huaweiDetOCR/weights/color_rec_deploy/plate_rec_color0325.pth', help='model.pt path(s)')  # REC颜色识别模型测试
    parser.add_argument('--source', type=str, default='/home/dell/桌面/huaweiDetOCR/img/images', help='source')  # file/folder, 0 for webcam
    ...
    # 3.PaddleOCR模型，字符识别
    # ocr = PaddleOCR(rec_model_dir='/home/dell/桌面/huaweiDetOCR/weights/paddleocr_deploy',
    #                 rec_char_dict_path='/home/dell/桌面/huaweiDetOCR/weights/paddleocr_deploy/chinese_plate_dict.txt',
    #                 use_angle_cls=False,
